...
export default function App(){
  ...
  function handleSelection(friend){
   ...
   function handlelesplitbill(value){
    setFriends((friend) => friend.id === selectedFriends.id?
  ...
  { selectedFriends && 
   <FormSplitBill
  selectedFriends={selectedFriends} onSplitBill={handlelesplitbill}/>}
  </div>
}
...
function FriendList ({friends, onSelection, selectedFriends}){
  ...
  return <ul>
    {friends.map((friend)=> <Friend friend={friend} key={friend.id} selectedFriends={selectedFriends} onSelection={onSelection}/>)}
  </ul>
}
